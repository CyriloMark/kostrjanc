...
import { arraySplitter } from "../comp_variable_screens/ProfileView";
  ...
  const register = async () => {
    ...
    createUserWithEmailAndPassword(
      ...
      .then((userCredential) => {
        ...
        uploadBytes(
          Storage.ref(getStorage(), "profile_pics/" + userCredential.user.uid),
          blob,
          userUploadMetadata
        )
          .then((snapshot) => {
      ...
      >
        ...
        <View style={styles.sectionContainer}>
          ...
          <Text style={styles.subText}>
            Zo bychu druhzy wědźeli, štó ty sy, směš swětej powědać, što tebje
            wučini!
          </Text>
        </View>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.genderContainer}>
            ...
            <Switch
              style={styles.switch}
              value={userData.gender === 0 ? false : true}
              thumbColor={"#B06E6A"}
        ...
        <View style={styles.sectionContainer}>
            ...
            {arraySplitter(ageOptions, 2).map((list, listKey) => (
              <View key={listKey} style={styles.ageGroupListContainer}>
                {list.map((ageGroup, ageGroupKey) => (
                  <SelectableBtn
                    key={ageGroupKey}
                    selected={userData.ageGroup === ageGroup.id}
          ...
          <Text style={styles.subText}>
            ...lět star{userData.gender == 0 ? "y" : "a"}.
          </Text>
        </View>
        ...
        <View style={styles.sectionContainer}>
          <Text style={styles.subText}>
            Ja mam tohorunja wosebite mjezwočo. Tutón wobraz je jedyn z
            najwosebitych.
          </Text>
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <Pressable
            ...
            onPress={() =>
              setUserData({ ...userData, agbChecked: !userData.agbChecked })
            }
          >
            <Pressable
              style={[
