...
export default function AuthLanding({ navigation }) {
  ...
  const [registerScreenVisibility, setRegisterScreenVisibility] =
    useState(false);
  ...
  // Register User -> UserRegisterScreen
  const register = () => {
  ...
  return (
    <View style={styles.container}>
      {/* Login */}
      <Modal
        onRequestClose={() => setLoginScreenVisibility(false)}
        visible={loginScreenVisibility}
        content={
          <ScrollView
            ref={loginScrollViewRef}
            style={{ width: "100%" }}
            scrollEnabled
            bounces
          >
      ...
      {/* Register */}
      <Modal
        onRequestClose={() => setRegisterScreenVisibility(false)}
        ...
        content={
          ...
          >
            ...
            <View style={styles.modalInputContainer}>
              <TextInput
                style={styles.modalInput}
                placeholder="Hesło wopodstatnić"
                maxLength={64}
                multiline={false}
                numberOfLines={1}
                placeholderTextColor={"#5884B0"}
            ...
            <Text style={styles.warnText}>
              Kedźbuj, zo wšitke daty prawje zapodaš, hewak maš wjac dźěła!
            </Text>
      ...
      {/* Reset PW */}
      <Modal
        onRequestClose={() => setResetScreenVisibility(false)}
        visible={resetScreenVisibility}
        content={
          <ScrollView
            ref={loginScrollViewRef}
            style={{ width: "100%" }}
          ...
          >
            <Text style={styles.modalTitle}>
              Email za změnjenje hesła pósłać
            </Text>
      ...
      >
        ...
        <View style={styles.titleContainer}>
          <Text style={styles.titleText}>
            Zaloguj so, abo wutwor nowy konto na kostrjanc
          </Text>
        </View>
        ...
        <View style={styles.buttonsContainer}>
          ...
          <Pressable
            style={styles.buttonContainer}
            onPress={() => setRegisterScreenVisibility(true)}
          >
          ...
          <Pressable
            style={styles.buttonContainer}
            onPress={() => setResetScreenVisibility(true)}
          >
