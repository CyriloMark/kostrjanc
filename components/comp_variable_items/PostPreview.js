  ...
  return (
    <View style={props.style}>
      <Pressable style={styles_main.container} onPress={props.press}>
        {props.item.type == 0 ? (
          <Preview_Post
            imgUri={props.item.imgUri}
            postShowText={props.postShowText}
            title={props.item.title}
            style={styles_main.box}
          />
        ) : (
          <Preview_Event
            title={props.item.title}
            geoCords={props.item.geoCords}
            checked={checked}
            style={styles_main.box}
          />
        )}
    ...
    <View style={props.style}>
      <View style={styles_post.postContainer}>
        ...
        <View style={styles_post.postTextContainer}>
          <Text
            style={[
              styles_post.postText,
              { opacity: !props.postShowText ? 0 : 1 },
            ]}
          >
            {props.title}
          </Text>
  ...
  return (
    <View style={props.style}>
      <View style={styles_event.eventContainer}>
        ...
        <View
          style={[
            styles_main.pinContainer,
            { backgroundColor: !props.checked ? "#5884B0" : "#B06E6A" },
          ]}
        >
        ...
        <View style={styles_event.eventTextContainer}>
          <Text style={styles_event.eventText}>{props.title}</Text>
        </View>
      </View>
    </View>
  );
