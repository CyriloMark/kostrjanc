      ...
      <View style={styles.container}>
        ...
        {props.comment ? (
          <Pressable style={styles.iconContainer} onPress={props.onComment}>
            <View style={styles.iconBG}>
              <SVG_Recent style={styles.itemIcon} fill="#5884B0" />
            </View>
          </Pressable>
        ) : null}
        ...
        {props.share ? (
          <Pressable style={styles.iconContainer} onPress={props.onShare}>
            <View style={styles.iconBG}>
              <SVG_Share style={styles.itemIcon} fill="#5884B0" />
            </View>
          </Pressable>
        ) : null}
        ...
        {props.report ? (
          <Pressable style={styles.iconContainer} onPress={props.onReport}>
            <View style={styles.iconBG}>
              <SVG_Warn style={styles.itemIcon} fill="#5884B0" />
            </View>
          </Pressable>
        ) : null}
        ...
        {props.userIsAdmin && props.ban ? (
          <Pressable style={styles.iconContainer} onPress={props.onBan}>
            <View style={styles.iconBG}>
              <SVG_Ban style={styles.itemIcon} fill="#5884B0" />
            </View>
          </Pressable>
        ) : null}
      </View>
