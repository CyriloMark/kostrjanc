...
export default function PostCreate({ navigation }) {
    ...
    const checkIfPublishable = () => {
        if (!(imageUri != null && postData.title.toString().length !== 0 && postData.description.toString().length !== 0))
    ...
    return (
        <View style={ styles.container }>
            ...
            <BackHeader style={ styles.backHeader } title="Nowy post wozjewić" onPress={ () => navigation.goBack() } />
            ...
            <ScrollView style={ styles.contentContainer } contentContainerStyle={[ styles.contentInnerContainer, { marginTop: -5 } ]} showsHorizontalScrollIndicator={false}
                ...
                <TextInput
                    ...
                    keyboardType="default" keyboardAppearance='dark' value={postData.title}
                ...
                />
                    ...
                    {/* Desc */}
                <TextInput
                    style={ styles.input } placeholder="Wopisaj twój post..." maxLength={512}
                    multiline placeholderTextColor={"#5884B0"} selectionColor={"#5884B0"}
                    keyboardType="default" keyboardAppearance='dark' value={postData.description}
