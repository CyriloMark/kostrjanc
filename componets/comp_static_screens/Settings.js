        ...
        <View style={ styles.container }>
            ...
            <ScrollView style={ styles.contentContainer } contentContainerStyle={[ styles.contentInnerContainer, { marginTop: -5 } ]} showsHorizontalScrollIndicator={false}
                ...
                <WarnButton style={ styles.sectionContainer } title={"Sy zmylk namakał?"} sub={"Přizjeł tutón nam prošu!"}
                    press={ () => openLink("https://kostrjanc.de/pomoc/bugs.html?return=index") } />
                ...
                <View style={ styles.sectionContainer }>
                    ...
                    <Text style={ styles.text } onPress={ copyIDToClipboard }>{userIdText}</Text>
                ...
                <View style={ styles.sectionContainer }>
                    ...
                    <LinkButton style={ styles.button } title={"...online formular"} link="http://verify.kostrjanc.de/" />
                    <CallButton style={ styles.button } title={"...abo ty zazłoniš direktnje"} link={"tel://01794361854"} />
                </View>
                ...
                <View style={ styles.sectionContainer }>
                    ...
                    <LinkButton style={ styles.button } title={"Sy zmylk namakał, potom přizjeł so prošu pola nas!"} link="https://kostrjanc.de/pomoc/bugs.html?return=index" />
