...
import { notificationAsync, impactAsync } from 'expo-haptics';
...
export default function ProfileView({ navigation, route }) {
    ...
    return (
        <View style={ styles.container } >
            ...
            <BackHeader style={ styles.backHeader } title={user.name} onPress={ () => navigation.goBack() } />
            <ReportModal type={2} visible={reportVisible} close={ () => setReportVisible(false) } id={userID} />
            ...
            <ViewInteractionsBar style={ styles.interactionsContainer } userIsAdmin={userIsAdmin}
                ...
                onBan={ banUser }
                report={ getAuth().currentUser.uid != userID } ban />
