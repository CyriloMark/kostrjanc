...
import { View, StyleSheet, Platform, KeyboardAvoidingView, Pressable, ScrollView, Text, TextInput} from 'react-native';
            ...
            <ScrollView ref={mainScroll} style={{ width: "100%" }} scrollEnabled bounces
                ...
                <View style={ styles.inputContainer }>
                    <TextInput
                        ...
                        multilin placeholderTextColor={"#5884B0"} selectionColor={"#5884B0"}
